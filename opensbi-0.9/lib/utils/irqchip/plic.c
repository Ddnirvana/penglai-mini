...
static void __init plic_set_priority(struct plic_data *plic, u32 source, u32 val)
{
...
void __init plic_set_thresh(struct plic_data *plic, u32 cntxid, u32 val)
{
...
void __init plic_set_ie(struct plic_data *plic, u32 cntxid, u32 word_index, u32 val)
{
...
int __init plic_warm_irqchip_init(struct plic_data *plic,
...
int __init plic_cold_irqchip_init(struct plic_data *plic)
{
	int i;
